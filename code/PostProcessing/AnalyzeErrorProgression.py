...
These scripts plot the progression of error and paramter values throughout a 
single inversion thread
...
AllAcceptedMatrix = pd.read_csv(folder+'AllAcceptedList.csv', delimiter=',') 
...
if(ploton==1):
    for i in range(nParameters):
        ...
        VarB_Vals = GlobalError['Mismatch']

        AllAcceptedList = AllAcceptedMatrix['AllAcceptedList']
