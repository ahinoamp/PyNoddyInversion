...
def create_lineaments2(values):
    ...
    folder2 = 'HistoryFileTransferRandom/Thread'+str(run_n)+'/'
    ...
    HypPara['output_name'] = folder2+'noddy_out'
...
if __name__== "__main__":
    params = {'run_n': 4458, 'hisfile': 'HistoryFileTransferRandom/561_G_4_Err_844.his'}
